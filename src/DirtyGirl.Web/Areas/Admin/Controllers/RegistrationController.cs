    ...
    public class RegistrationController : BaseController
    {
        ...
        public ActionResult Ajax_GetEventRegistrants([DataSourceRequest] DataSourceRequest request, int eventId)
        {
            return Json(_registrationService.GetRegistrationsByEvent(eventId).Select(r => new
            {
                ...
                r.User.Address1,
                r.User.Address2,
                City = r.User.Locality,
                State = r.User.Region.Name,
                Zip = r.User.PostalCode,
                r.Phone,
                r.Email,
                r.EmergencyContact,
                r.EmergencyPhone,
            ...
            var result = registrations.Select(reg => new vmAdmin_RegistrationListItem
                                                         {
                                                             ...
                                                             Address1 = reg.User.Address1,
                                                             Address2 = reg.User.Address2 ?? string.Empty,
                                                             City = reg.User.Locality,
                                                             State = reg.User.Region.Code,
                                                             Zip = reg.User.PostalCode,
                                                             Phone = reg.Phone,
                                                             Email = reg.Email,
